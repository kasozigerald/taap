...
<head>
    ...
    <body id="home" data-spy="scroll" data-offset="70" class="consulting-body-color">
		...
		<section id="challenge" class="consulting-services-area pt-100 pb-70">
			...
			<p>Whereas development partners, venture capitalists (VC) and angle investers are available globally to direct and tackle the problems in Uganda and
			Africa as a whole, there is a gap of institutional readiness to absorb the funding and also
			ensure delivery of the IMPACT as promised on a sustainable scale. The VC ESOs has disbursed approximately USD 100M to over 100 startups and intermediaries in the market to support job creation, skills development and financial inclusion, there is very little to show for this investiment
			 (and this valueis promised to double with more funders coming on board). It is documented that most
			of the sub guarantees do not have well defined and sustainable business capabilities to
			deliver the outcomes as promised to the VCs, create 3M jobs, support 1000 startups and provide financial services to 10M Village Loan Schems.
			These challenges are organizational, systematic, process, technological and people
			orientated. However, we are also aware that the current funding model does not provide
			for Technical Assistance to the recipients hence leaving them exposed and unable to
			deliver on the mandate of the ESOs. This problem persists and holds back the growth and
			revolution in solving sector based problems such as youth unemployment, outdated
			education systems, lack of access to micro insurance, Financial inclusion, environment,
			limited food sustainability through smart agriculture, fragmented access to energy,
			deprivation of media and information, gender and human rights among others. There is therefore need to build and provide robust Technical Assistance and Acceletration Programs that will ensure sustainability of the ecosystem, continuity of disruptive youth led startups that are built on sound systems and can systems and scale. Its
			therefore important that the funding to Entrepreneur and Enterprise Support
			Organizations (ESOs) is accompanied with Technical Assistance to guarantee delivery
			and sustainability.
             </p>
			</div>
		</div>
                ...
                <div class="section-title seo-title" id="solution">
                    ...
                    <h5 class="text-dark">Our Technical Areas Consists of the Following Modules</h5>
                </div>
            </div>
                </div> 
                <div class="row">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-consulting-services bg-2">
							<h4>People and  Organisational Capability</h4>
...
requisite skills and capabilities in the team is paramount.</p>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-consulting-services bg-1">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-consulting-services bg-3">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-consulting-services bg-4">
...
generated by the investment.</p>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-consulting-services bg-5">
...
proposals in line with the funding guidelines of the funder.</p>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="single-consulting-services bg-6">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="consulting-about-content">
							<span>What is TAAP</span>
							<h3>TAAP-Technical Assistance and Acceleration Program Initiative
							</h3>
															
							<p class="use-mb">TAAP is focused on building both internal organizational capability and support for
entrepreneur and enterprise support organizations, or intermediaries, in Uganda. The
project will build organisational capacity through bootcamps and the provision of 1:1
business advisory support. The TAAP project aims to improve the quality of
intermediaries in Uganda, and thus the quality of support that SMGEs and start-ups
receive.
</p>
							...
							<div class="row">
								<div class="col">
									<div class="single-about">
										<h3>Something about AELS</h3>
										<p>AELS is a team of specialists that focuses on delivering value across the organizational
							...
							<div class="row pt-100">
								<div class="col">
									<h3>Our client base at AELS is evidence of our result producing programmes.</h3>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- Start Partner Area -->
		<div class="partner-area consulting-partner-area pb-100">
			<div class="container">
				<div class="partner-slider owl-theme owl-carousel">
					<div class="partner-item">
						<a href="#">
							<img src="assets/img/consulting/partner/Nice.png" alt="Image">
						</a>
					</div>

					<div class="partner-item">
						<a href="#">
							<img src="assets/img/consulting/partner/ubl.png" alt="Image">
						</a>
					</div>

					<div class="partner-item">
						<a href="#">
							<img src="assets/img/consulting/partner/jessa.png" alt="Image">
						</a>
					</div>

					<div class="partner-item">
						<a href="#">
							<img src="assets/img/consulting/partner/nh.png" alt="Image">
						</a>
					</div>

					<div class="partner-item">
						<a href="#">
							<img src="assets/img/consulting/partner/ughm.png" alt="Image">
						</a>
					</div>
				</div>
			</div>
		...
		<section id="faq" class="seo-about-area ptb-100">
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-4">
						<div class="about-img">
							<img src="assets/img/consulting/about-img.jpg" alt="Image">
						</div>
					</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-9">
						...
						<h2>Lets get started on transforming your enterprise today!</h2>
						</div>
					</div>

					<div class="col-lg-3">
						<div class="get-in-touch-btn">
							<a href="quote.php" class="default-btn">
								SignUp
							</a>
						</div>
					</div>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-sm-6">
										<select class="form-control" id="subject" name="subject" required>
											...
											<option value="SignUp">Request a Quote</option>
											<option value="SignUp">SignUp for TAAP</option>
											<option value="Inquiry">TAAP Inquiry</option>
											<option value="Others">Other Needs</option>
										</select>
									</div>
